...
def save_availability_data_to_db(
    data: str, in_engine: sqla.engine.base.Connection
) -> None:
    """
    Function to load the data of the stations into the database.
    ...
    for station in stations:
        ...
        v_station_id = station.get("number")  # Changed from number to station_id
        v_last_update = datetime.datetime.fromtimestamp(
            station.get("last_update") / 1000
        )
